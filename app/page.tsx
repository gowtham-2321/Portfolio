      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800 bg-black/80 backdrop-blur-sm">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="https://drive.google.com/file/d/1bm-_B1mpvnTCyAcAe9vubIpwkNbR7vCZ/view?usp=sharing" target="_blank">
              <Button
                variant="outline"
      ...
      <section className="py-20 bg-black" id="projects">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Link href="https://medplay.vercel.app" target="_blank" className="block h-full">
              <ProjectCard
                title="Medplay"
